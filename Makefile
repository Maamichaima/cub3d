...
SRC = main.c parse_map.c textures.c check_color.c parse_textures.c check_all.c get_map.c lst.c draw.c key_hook.c casting_rays.c\
	cast_vertical.c render_3D.c mini_map.c textures_buffer.c animation.c garbage.c info_map.c slide.c move.c color_util.c\
	check_player.c initialize.c initialize_2.c mouse_hook.c
OBJ = $(SRC:.c=.o)
